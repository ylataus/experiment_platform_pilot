$(function() {
	...
	var media_left = $("<div>",{class:"media-left"})
	    media_left.append('<div class="vote comment-votes" data-msg_id='+data.id+'> <div><i class="fa fa-chevron-up" name="upvote"></i></div><div class="score">0</div><div><i class="fa fa-chevron-down" name="downvote"></i></div> </div> ')
