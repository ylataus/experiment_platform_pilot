$(function() {
	...
	alert(message.data);
	    ele.append('<div class="media-left"><div class="vote comment-votes" style="float:left;" data-msg_id='+data.id+'> <div><i class="fa fa-chevron-up" name="upvote"></i></div><div class="score">0</div><div><i class="fa fa-chevron-down" name="downvote"></i></div> </div>  ')
	
	//ele.append($"<th rowspan="3"></th>")
	//ele.append($'<tr>')
        ele.append(
            $("<span>",{class: "msgtext",style: "vertical-align:middle;",text: data.message})
        )
	ele.append('</br>')
        ele.append(
            $("<span>",{class: "handle",style:"vertical-align:middle; font-style:italic;" ,text: " - ".concat(data.handle)."-"})
            
        )
	//ele.append($"</tr>")
        ele.append(
            $("<span>",{class: "timestamp",style:"vertical-align:middle;font-style:italic;",text: data.timestamp})
        )
	ele.append('</div>')
